...
uint32_t evalAsmLn(char* asmLn) {
	...
	if (strcmp(op, "ADD") == 0) { //Instead of the inevitable "if... else if" tree that will result with more command, next project I will update this to be a hash function inside a switch case 
